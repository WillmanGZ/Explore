...
public class DragHand : MonoBehaviour, IDragHandler, IEndDragHandler, IBeginDragHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData) //Se llama solo una vez, al empezar el drag
    {
        ...
        startPosition = transform.position; //Toma la posicion del objeto al que está asignado el script
        startParent = transform.parent; //Toma el parent del objeto al que está asignado el script
